...
<html lang="en" dir="ltr">
  ...
  <body>
    <header>
      <a href="index.html"><img src="../IMG/LogotipoNavbar.png" alt="logo"></a>
      ...
      <div class="profile">
        ...
        <ul>
          ...
          <li><a href="listUser.php">Backoffice</a></li>
          <?php 
...
<button id="flip"><img src="../img/faqPlus.png" alt="plus"></button>
