...
<html lang="en" dir="ltr">
  ...
  <body>
    <header>
      ...
      <div class="banner">
        <ul class="nav justify-content-center tipo">
          <li class="nav-item">
        ...
        <form action="https://www.google.pt/?gfe_rd=cr&dcr=0&ei=KV3BWY7xConY8gfGpKRA&gws_rd=ssl" method="get" class="searchbar" autocomplete="off">
          <input type="text" placeholder="Pesquisar Receita" name="q">
          <button type="button"><i class="fa-solid fa-magnifying-glass lupa"></i></button>
        </form>
      </div>
