...
?>
  ...
  <div class="imagemcentro">
    <img src="../IMG/fooddarktheme.jpg" alt="pequeno-almoço saudável" />
  </div>
  <div class="textofoto1">
    Notícias
  </div>
    ...
    <?php 
      ...
      <div class='page__container'>
          <a href='#popup-article?id=$row->IDNoticia' class='open-popup'><img src='../IMG/".$row->fotos."' alt=''></a>
      </div>
  </div>
  <div id='popup-article?id=$row->IDNoticia' class='popup'>
