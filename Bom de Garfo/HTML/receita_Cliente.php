...
<div id="receita_Cliente">
  ...
  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-item active">
              <img src="../IMG/comida.jpg" alt="comida" style="border-radius: 30px;margin-bottom: 10px;" class="img_carosel">
              <h3>Bife</h3>
    </div>
              ...
              if (isset($photo_1)) {
                ...
                while ($row = $photo_1->fetch_object()) {
                  ...
                  echo '<span class="carousel-item">
                        <img src="../IMG/receitasimg/' .$row->fotos. '" alt="comida" style="border-radius: 30px;margin-bottom: 10px;" class="img_carosel">
                        <h3>' .$row->titulo. '</h3>
                      </span>';
  ...
  <div class="estruturacard">
      <?php
              $query = "SELECT * FROM receitas WHERE user='sim'";
