...
<html lang="pt-PT" dir="ltr">
  ...
  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-item active">
              <img src="../IMG/comida.jpg" alt="comida" style="display:flex;margin:auto;border-radius: 30px;margin-bottom: 10px;" class="img_carosel">
              <h3>Bife</h3>
    </div>
          ...
          <?php
              ...
              if (isset($photo_1)) {
                ...
                while ($row = $photo_1->fetch_object()) {
                  ...
                  echo '<span class="carousel-item">
                        <img src="../IMG/receitasimg/' .$row->fotos. '" alt="comida" style="display:flex;margin:auto;border-radius: 30px;margin-bottom: 10px;" class="img_carosel">
                        <h3>' .$row->titulo. '</h3>
                      </span>';
