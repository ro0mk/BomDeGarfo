...
session_start();
    ...
    if (move_uploaded_file($_FILES['fotos']['tmp_name'],$folder.$novo_ficheiro)) {
        ...
        $receitanova_Cliente="INSERT INTO receitas (titulo,cozinheiro,fotos,descricao,ingredientes,grau_dificuldade,doses,categoria,epoca,tempo_preparacao,user) 
                        VALUES('".$titulo."','".$cozinheiro."','".$novo_ficheiro."','".$descricao."','".$ingredientes."','".$grau_dificuldade."','".$doses."','".$categoria."','".$epoca."','".$tempo_preparacao."','".$user_sim."')"; 
        $conn->query($receitanova_Cliente);
        }
        
        header('Location: receita_Cliente.php');
